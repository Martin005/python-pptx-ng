...
def msdn_msoAutoShapeTypes():
    ...
    return (
        ...
        (
            ...
            129,
            "Back or Previous button. Supports mouse-click and mouse-over actio" "ns.",
        ),
        (
        ...
        (
            ...
            130,
            "Forward or Next button. Supports mouse-click and mouse-over action" "s.",
        ),
        (
        ...
        (
            ...
            116,
            "Callout with accent bar and callout line segments forming a U-shap" "e.",
        ),
        (
...
def const_name_map():
    ...
    enumeration names to the constant names used in python-pptx-ng to identify
